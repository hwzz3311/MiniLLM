...
- 测试自己训练的tokenizer和qwen2、minimind的性能差距
  1. 我们发现自己训练tokenizer时设定的vocab为6400，但是加载后vocab就变为了6402，排查分析时由于add_bos_token=True,add_prefix_space=False,导致增加了两个。需要重新修正代码，多轮测试对比分析。
   
- 测试更大的tokenizer vocab对收敛速度的影响，以及对最终模型效果的影响✅
